...
function setEmailInputPlaceholderText(){
    if( $(this).width() < 769 ) {
        $("#email2").attr('placeholder', '이메일 입력하고 사전 신청!');
    } else {
        $("#email2").attr('placeholder', '이메일 입력하고 사전 신청!');
    }
}
...
function setEmailInputPlaceholderText(){
    if( $(this).width() < 769 ) {
        $("#email").attr('placeholder', '연봉 입력하고 투자금액 알아보기');
    } else {
        $("#email").attr('placeholder', '연봉 입력하고 투자금액 알아보기');
    }
}
...
$(document).ready(function(){
    ...
    $('#SECTION05 .tab-title-text').on('click', function(){
        ...
        $(this).find("img").attr('src', 'static/images/main_pc/g5_tab_0'+ selectedNo +'_over.png')
        $("#TAB2_IMG").attr('src', 'static/images/main_pc/s2_0'+ selectedNo +'.png');
